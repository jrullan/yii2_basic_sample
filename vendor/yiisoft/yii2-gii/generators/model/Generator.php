...
class Generator extends \yii\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['generateLabelsFromComments', 'useTablePrefix', 'useSchemaName', 'generateQuery', 'autoFillName'], 'boolean'],
            [['enableI18N'], 'boolean'],
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'autoFillName' => 'Autogenerate Name Fields',
        ]);
    }
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'autoFillName' => 'This option creates a beforeSave filter in the model to autogenerate the name of new records of this model incrementally.',
        ]);
    }
    ...
    public function getTablePrefix()
    {
      ...
      if ($db !== null) {
		 ...
		 */
		public function getForeignKeysList($tableName){
				$db = $this->getDbConnection();
